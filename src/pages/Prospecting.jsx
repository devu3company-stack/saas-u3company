...
const Prospecting = () => {
    ...
    const importToCRM = () => {
        ...
        const currentClients = JSON.parse(localStorage.getItem('u3_clientes') || '[]');
        ...
        localStorage.setItem('u3_clientes', JSON.stringify([...newClients, ...currentClients]));

        const currentPipeline = JSON.parse(localStorage.getItem('u3_leads') || '[]');
        ...
        localStorage.setItem('u3_leads', JSON.stringify([...currentPipeline, ...newLeadsPipeline]));
